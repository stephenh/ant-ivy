...
public class PomModuleDescriptorParserTest extends AbstractModuleDescriptorParserTester {
    ...
    public void testOptional() throws Exception {
        ...
        assertEquals(ModuleRevisionId.newInstance("cglib", "cglib", "2.0.2"),
            dds[1].getDependencyRevisionId());
        assertEquals(new HashSet(Arrays.asList(new String[] {"compile", "runtime", "sources"})),
        ...
        assertEquals(new HashSet(Arrays.asList(new String[] {"sources()"})),
            new HashSet(Arrays.asList(dds[1].getDependencyConfigurations("sources"))));
        ...
        assertEquals(new HashSet(Arrays.asList(new String[] {"sources()"})),
            new HashSet(Arrays.asList(dds[2].getDependencyConfigurations("sources"))));
    }
    ...
    public void testDependenciesWithScope() throws Exception {
        ...
        assertEquals(ModuleRevisionId.newInstance("odmg", "odmg", "3.0"),
            dds[0].getDependencyRevisionId());
        assertEquals(new HashSet(Arrays.asList(new String[] {"runtime", "sources"})), new HashSet(
                Arrays.asList(dds[0].getModuleConfigurations())));
        assertEquals(
